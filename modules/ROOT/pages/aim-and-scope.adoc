...
* xref:en/agile-methodologies:ROOT:introduction.adoc[Agile Methodologies Guide]
* xref:en/tech-sovereignty:ROOT:introduction.adoc[Technological Sovereignty Guide]
* xref:en/data-management:ROOT:summary.adoc[Government Measure on Ethical Data Management]
...
* xref:en/ict-procurement:ROOT:context.adoc[ICT Procurement Guide]
* xref:en/innovative-procurement:ROOT:innovating.adoc[Innovative Public Procurement Guide]
