...
Architecture and interoperability requirements, and the right and ability to modify and reuse the software of digital systems and services, will be regarded as part of the technical features and specifications.
...
Open data will be provided in a machine readable format (i.e. CSV, XML, JSON or other similar formats that facilitate fine-grained automatic data processing and transformation), and updated regularly.
